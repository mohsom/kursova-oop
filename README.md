...
- ✅ **Управління планами** - створення планів підписок з цінами в USD
- ✅ **Управління підписками** - додавання підписок, скасування
- ✅ **Paddle Style Оплата** - вибір користувача та плану, розрахунок вартості
- ✅ **Симуляція оплати** - створення транзакцій з симуляцією успіху/невдачі
- ✅ **Перевірка ліцензій** - перегляд стану підписок користувачів з датами закінчення
